        ...
        _buildSection(
          ...
          children: [
            _buildActionTile(
              ...
              title: _hasRated
                  ? (isZh ? '感谢您的评分！' : 'Thanks for Rating!')
                  : (isZh ? '给 Musly 评分' : 'Rate Musly'),
              subtitle: _hasRated
                  ? (isZh ? '您已经为应用评过分' : 'You\'ve already rated the app')
                  : (isZh ? '分享您的宝贵意见' : 'Share your feedback'),
            ...
            _buildActionTile(
              ...
              title: isZh ? '支持 Musly' : 'Support Musly',
              subtitle: isZh ? '加入 Discord 或进行捐赠' : 'Join Discord or donate',
                ...
                ConstrainedBox(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: isZh ? '可选反馈意见...' : 'Optional feedback...',
